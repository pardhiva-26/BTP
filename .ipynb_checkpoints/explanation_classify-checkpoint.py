...
@click.option('--train_dir', help='input', required=True, metavar='DIR',default='/scratch/sg/nagendra/Mocheg/data/train') 
@click.option('--val_dir', help='input', required=True, metavar='DIR',default='/scratch/sg/nagendra/Mocheg/data/val') 
@click.option('--test_dir', help='input', required=True, metavar='DIR',default='/scratch/sg/nagendra/Mocheg/data/test') 
