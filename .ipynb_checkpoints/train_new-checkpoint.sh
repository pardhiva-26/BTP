...
# python retrieve_train.py  --epochs=2
# python retrieve_train.py --train_config=BI_ENCODER  --media=txt  --epochs=1
## inference
...
# python retrieve_similarity_recall.py --bi_encoder_checkpoint=/scratch/sg/nagendra/Mocheg/retrieval/output/runs_3/00017-train_bi-encoder-multi-qa-MiniLM-L6-cos-v1-2025-11-02_20-57-23 --image_encoder_checkpoint=/scratch/sg/nagendra/Mocheg/retrieval/output/runs_3/00025-train_bi-encoder-clip-ViT-B-32-2025-11-05_21-41-45 --media=img_txt  --top_k=5  --in_dir=/scratch/sg/nagendra/Mocheg/data/val 
# python retrieve_similarity_recall.py --bi_encoder_checkpoint=/scratch/sg/nagendra/Mocheg/retrieval/output/runs_3/00017-train_bi-encoder-multi-qa-MiniLM-L6-cos-v1-2025-11-02_20-57-23 --image_encoder_checkpoint=/scratch/sg/nagendra/Mocheg/retrieval/output/runs_3/00025-train_bi-encoder-clip-ViT-B-32-2025-11-05_21-41-45 --media=img_txt  --top_k=5  --in_dir=/scratch/sg/nagendra/Mocheg/data/train 

# python retrieve_similarity_recall.py --bi_encoder_checkpoint=/scratch/sg/nagendra/Mocheg/retrieval/output/runs_3/00017-train_bi-encoder-multi-qa-MiniLM-L6-cos-v1-2025-11-02_20-57-23 --image_encoder_checkpoint=/scratch/sg/nagendra/Mocheg/retrieval/output/runs_3/00025-train_bi-encoder-clip-ViT-B-32-2025-11-05_21-41-45 --media=img_txt  --top_k=5  --in_dir=/scratch/sg/nagendra/Mocheg/data/test
...
# CUDA_VISIBLE_DEVICES=2 python verify.py --mode=inference --save_in_checkpoint_dir="n" --model_type=CLAIM_TEXT_IMAGE_attention_5_4   --checkpoint_dir=/scratch/sg/nagendra/Mocheg/verification/output/runs/00026-
# CUDA_VISIBLE_DEVICES=3 python verify.py --mode=inference --save_in_checkpoint_dir="n" --model_type=CLAIM_TEXT_IMAGE_attention_5_4   --checkpoint_dir=/scratch/sg/nagendra/Mocheg/verification/output/runs/00026- --evidence_file_name=retrieval/retrieval_result.csv 
...
# CUDA_VISIBLE_DEVICES=1 python explanation_classify.py  --epoch=2
